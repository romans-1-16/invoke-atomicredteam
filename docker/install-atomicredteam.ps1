    ...
    Try {
        ...
        if ($Force -or -Not (Test-Path -Path $InstallPathwIart )) {
            ...
            if ($getAtomics) {
                ...
                Invoke-Expression (Get-Content -Raw ./install-atomicsfolder.ps1); Install-AtomicsFolder -InstallPath $InstallPath -DownloadPath $DownloadPath -Force:$Force -RepoOwner $RepoOwner -NoPayloads:$NoPayloads
            }
