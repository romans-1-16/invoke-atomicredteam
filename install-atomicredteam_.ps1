    ...
    Try {
        ...
        if ($Force -or -Not (Test-Path -Path $InstallPathwIart )) {
            ...
            if ($getAtomics) {
                ...
                Invoke-Expression (IWR 'https://raw.githubusercontent.com/$RepoOwner/invoke-atomicredteam/$Branch/install-atomicsfolder.ps1'); Install-AtomicsFolder -InstallPath $InstallPath -DownloadPath $DownloadPath -Force:$Force -RepoOwner $RepoOwner -NoPayloads:$NoPayloads
            }
